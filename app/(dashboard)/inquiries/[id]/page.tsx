    ...
    <div className="max-w-3xl space-y-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/inquiries" className="p-1.5 rounded-lg hover:bg-brand-gray-200 transition-colors">
            <ChevronLeft size={18} className="text-brand-gray-600" />
          </Link>
          <div>
            <h1 className="text-lg font-bold text-brand-black leading-none">{inq.name}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-brand-gray-200 p-5">
            <h2 className="text-sm font-semibold text-brand-black mb-2">Notes</h2>
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={5}
              placeholder="Follow-up actions, quoted price, internal notes..."
