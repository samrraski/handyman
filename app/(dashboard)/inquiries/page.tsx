      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-brand-gray-400 mt-0.5">
            ...
            {newCount > 0 && (
              <span className="ml-2 text-brand-yellow font-semibold">· {newCount} new</span>
            )}
          </p>
        </div>
      </div>
      ...
      {inquiries && inquiries.length > 0 ? (
        ...
        <div className="bg-white rounded-xl border border-brand-gray-200 py-20 text-center">
          ...
          <p className="text-sm text-brand-gray-400">
            No inquiries yet. They&apos;ll appear here when customers submit a request from the calculator.
          </p>
        </div>
      )}
    </div>
